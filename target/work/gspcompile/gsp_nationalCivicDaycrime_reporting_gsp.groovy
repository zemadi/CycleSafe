...
class gsp_nationalCivicDaycrime_reporting_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/crime-reporting.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('captureBody','sitemesh',263,['data-spy':("scroll"),'data-target':(".bs-docs-sidebar")],1)
printHtmlPart(6)
}
...
public static final long LAST_MODIFIED = 1401510723040L
